...
##  matinv<-makeCacheMatrix(A)               #generate the list of functions for A 
##  cacheSolve(matinv)                       #computes and returns the inverse of A
##  cacheSolve(matinv)                       #when called a second time, cacheSolve
